...
Shader "Ultimate 10+ Shaders/Plasma"
{
    Properties
    {
        ...
        _MovementDirection ("Movement Direction", float) = (0, -1, 0, 0)
    ...
    SubShader
    {
        ...
        {
            IN.uv_NoiseTex += _MovementDirection;
            IN.uv_MainTex += _MovementDirection * _Time.x/2.0;
            IN.uv_Normal += _MovementDirection * _Time.x / 2.0;
